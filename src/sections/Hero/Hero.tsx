...
export const Hero: React.FC = () => {
  ...
  return (
    <section className="relative min-h-[85vh] md:min-h-[95vh] flex items-center justify-center md:justify-start overflow-hidden bg-primary py-16 md:py-24">
      ...
      <Container className="relative z-10 text-center md:text-left pt-12 md:pt-0">
        <div className="max-w-[850px] mx-auto md:mx-0 flex flex-col items-center md:items-start">
          <div className="flex flex-wrap justify-center md:justify-start items-center mb-6 relative">
            <motion.h1
              className="text-[clamp(2.5rem,8vw,5.5rem)] font-semibold leading-[1.05] tracking-[-0.03em] text-white text-center md:text-left"
              variants={container}
              initial="hidden"
              animate="visible"
            >
